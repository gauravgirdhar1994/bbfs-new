                                        ...
                                        <div className="row align-items-center">
                                            <div className="col-lg-6 col-md-12 why-we-different-content">
                                                <div className="tabs_item_content">
                                                    ...
                                                    <p>Our foundation programme is BBFS’ primary channel to enrich every child’s life through football. We deliver to every student a holistic experience, which focuses on interaction, learning and growth.</p>
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-lg-6 col-md-12 why-we-different-content">
                                                ...
                                                <div className="tabs_item_img">
                                                    ...
                                                    <p>BBFS Residential Football Academy is the premier platform for aspiring football players to initiate and accelerate their journey towards a professional pathway in football.</p>
